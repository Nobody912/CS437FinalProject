...
import { GitMergeIcon, GitPullRequestIcon, IssueClosedIcon, IssueOpenedIcon, GitBranchIcon } from "@primer/octicons-react"
...
export default function AuthView() {
  ...
  useEffect(() => {
    ...
    }, 10000); // Set the interval time in milliseconds
  ...
  return (
    <>
      <div className="flex flex-col w-full h-full justify-start items-center">
        <nav ref={navRef} className="flex flex-row w-full justify-start items-center gap-4 p-4 bg-github-slate-700">
        ...
        <div ref={contentRef} className="relative flex flex-col w-full h-full justify-start items-center p-8 bg-github-slate-800" style={{ "height": contentHeight }}>
          ...
          {repo?.commits !== undefined ? (
            <div className="flex flex-col w-full h-full justify-start items-center gap-x-8 outline outline-1 outline-white/10 divide-y divide-white/10 rounded-lg overflow-clip">
              <div className="flex flex-row w-full p-4 bg-github-slate-700">
